...
user in an INI file next to GodotPortable.exe called GodotPortable.ini.
...
copy AppNamePortable.ini from this directory to GodotPortable.ini next to
GodotPortable.exe. The options in the INI file are as follows:
